(define-library (raylib)
  ...
  (c-export (init-window "init_window" 3 3)
            ...
            (is-window-ready "is_window_ready" 0 0)
            (is-window-fullscreen "is_window_fullscreen" 0 0)
            (is-window-hidden "is_window_hidden" 0 0)
            (is-window-minimized "is_window_minimized" 0 0)
            (is-window-maximized "is_window_maximized" 0 0)
            (is-window-focused "is_window_focused" 0 0)
            (is-window-resized "is_window_resized" 0 0)
            (set-window-state "set_window_state" 0 -1)
            (clear-window-state "clear_window_state" 0 0)
            (toggle-fullscreen "toggle_fullscreen" 0 0)
            (toggle-borderless-windowed "toggle_borderless_windowed" 0 0)
            (maximize-window "maximize_window" 0 0)
            (minimize-window "minimize_window" 0 0)
            (restore-window "restore_window" 0 0)
            (set-window-title "set_window_title" 0 0)
            (set-window-position "set_window_position" 0 0)
            (set-window-min-size "set_window_min_size" 0 0)
            (set-window-max-size "set_window_max_size" 0 0)
            (set-window-size "set_window_size" 0 0)
            (get-screen-width "get_screen_width" 0 0)
            (get-screen-height "get_screen_height" 0 0)
            (get-render-width "get_render_width" 0 0)
            (get-render-height "get_render_height" 0 0)
