...
echo "==== v15 ===="
cd ..
git clone .. --branch=v15 v15 >/dev/null 2>&1
cd v15
cp ../v14/whisper-v14 .
make
...
echo "==== v16 ===="
cd ..
git clone .. --branch=v16 v16 >/dev/null 2>&1
cd v16
cp ../v15/whisper-v15 .
make
...
echo "==== v17 ===="
cd ..
git clone .. --branch=v17 v17 >/dev/null 2>&1
cd v17
cp ../v16/whisper-v16 .
make
...
echo "==== v19 ===="
cd ..
git clone .. --branch=v19 v19 >/dev/null 2>&1
cd v19
cp ../v18/whisper-v18 .
make
...
echo "==== v20 ===="
cd ..
git clone .. --branch=v20 v20 >/dev/null 2>&1
cd v20
cp ../v19/whisper-v19 .
make
...
echo "==== v21 ===="
cd ..
git clone .. --branch=v21 v21 >/dev/null 2>&1
cd v21
cp ../v20/whisper-v20 .
make
...
echo "==== v22 ===="
cd ..
git clone .. --branch=v22 v22 >/dev/null 2>&1
cd v22
cp ../v21/whisper-v21 .
make
